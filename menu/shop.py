...
class Shop:
    ...
    def render(self):
        ...
        self.multiplier_image=engine.render_text('birthstone',80,f'x{self.game.stats.multiplier*2} MULTIPLIER',(50,50,150))
        self.width_multiplier_image,self.length_multiplier_image=self.multiplier_image.get_size()
        engine.render_image(self.multiplier_image,((engine.DISPLAY_W - self.width_multiplier_image)/2,200))
